...
Write a program that uses console.log to print all the numbers from 1-100, with two exceptions.
For numbers disvisible by 3, print "Fizz" for numbers divisible by 5, print "buzz". When you 
have that working, modify your program to print "Fizzbuzz" for numbers that are divisible by 
